...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#eeeeee', '#af0000', '#008700', '#5f8700', '#0087af', '#878787', '#005f87', '#444444', '#bcbcbc', '#d70000', '#d70087', '#8700af', '#d75f00', '#d75f00', '#005faf', '#005f87']"
        dset background-color "'#eeeeee'"
        dset foreground-color "'#005f87'"
